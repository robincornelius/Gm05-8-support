...
#ifndef _GMCONTROL2CP_H_
#define _GMCONTROL2CP_H_
...
template <class T>
class CProxy_IGM0Control2Events : public IConnectionPointImpl<T, &DIID__IGM0Control2Events,  CComDynamicUnkArray_GIT>
{
	//Warning this class may be recreated by the wizard.
public:
	HRESULT Fire_NewData()
	{
